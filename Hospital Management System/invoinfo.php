...
<title>Covid Care hospital</title>
...
<body>
<div style="background-color: #7BC6CC">
...
<h1 class="text-center ">Covid Care Hospital<br /><small style="font-size:20px">Hospital Management System</small></h1></div>
</div>
</div><br><br><br>
<div class="container-fluid">
<div class="row">
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="invoinfo.php"><strong>All Home Quarantine Patients Invoices</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="invoadinfo.php"><strong>All Admited Patient Invoices</strong></a></li>
...
<h3 style="font-family:calibri;" class="text-center">All Home Quarantined Invoiceses</h3></div>
</div>
</div>
</div>
