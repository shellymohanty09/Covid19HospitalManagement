...
<h1 class="text-center ">Covid Care Hospital<br /><small style="font-size:20px">Hospital Management System</small></h1>
</div>
</div>
</div>
<br />
...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>This project shows the database management system for covid hospital keeping track of home quarantined and admitted patients in hospital
<br>
...
Project by Shreyansh, Shelly and Shyam
        </div>
    </div>
    </div>
	</footer>
